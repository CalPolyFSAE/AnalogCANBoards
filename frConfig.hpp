...
static constexpr CANmessage CAN1 = { CAN identifier, sendcanMOB0 }; //sp 
static constexpr CANmessage CAN2 = { CAN identifier, sendcanMOB1 }; //fbp, rbp, fa
static constexpr CANmessage CAN3 = { CAN identifier, sendcanMOB2 }; //spp
