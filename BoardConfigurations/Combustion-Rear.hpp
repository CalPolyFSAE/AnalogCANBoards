//Define CAN Messages
static constexpr CANMessage CAN1 = { ADC_C, VIN1, VIN3, VIN5, VIN7, 0x0D0, sendcanMOB0 };
static constexpr CANMessage CAN2 = { ADC_C, VIN8, VINund, VINund, VINund, 0x0D1, sendcanMOB1 };
...
//Define Sample rates
static constexpr CANMessage message200[] = { CAN1, CAN3 };
static constexpr CANMessage message100[] = { CAN2 };
static constexpr uint8_t Message200length = 2; //length of message200[]
static constexpr uint8_t Message100length = 1; //length of message100[]
