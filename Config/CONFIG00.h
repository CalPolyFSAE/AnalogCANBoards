...
constexpr SensorData Sensor00 = {
        ...
        CANChannel0,                   // CAN Channel to use for this sensor
        CANDATAChannel::CANC0,  // CAN Data Channel to use for this sensor
...
constexpr SensorData Sensor01 = {
        ...
        16,                     // Max expected value (converted)
        CANChannel0,                   // CAN Channel to use for this sensor
        CANDATAChannel::CANC1,  // CAN Data Channel to use for this sensor
        7,                      // ADC Channel to read
        conversion00            // Function to convert data
};
...
constexpr SensorData Sensor02 = {
        5,                      // Min expected value (converted)
        16,                     // Max expected value (converted)
        CANChannel1,                   // CAN Channel to use for this sensor
        CANDATAChannel::CANC0,  // CAN Data Channel to use for this sensor
        7,                      // ADC Channel to read
        conversion00            // Function to convert data
};
